...
parser.add_argument("-t", "--task", help="Which benchmark task to plot", choices=["gemm", "inversion", "similarity", "coord-transform"], type=str, required=True)
...
if args.task != "coord-transform" and args.backend != "custom":
	...
	if args.task == "similarity" and args.backend == "eigen":
